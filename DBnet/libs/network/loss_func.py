...
class BalanceCrossEntropyLoss(nn.Module):
    ...
    def forward(self,
        ...
        loss = F.binary_cross_entropy_with_logits(pred, gt, reduction='none')           # 这里注意函数中会执行sigmoid操作
...
class DBLoss(nn.Module):
    def __init__(self, params, reduction='mean', eps=1e-6):
        ...
        self.alpha = params.TRAIN.loss_alpha
        self.beta = params.TRAIN.loss_beta
        self.ohem_ratio = params.TRAIN.loss_ohem
